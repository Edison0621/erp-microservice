                ...
                <div className="flex p-1 bg-gray-100 rounded-xl border border-gray-200">
                    {['Real-time', 'Daily', 'Weekly', 'Quarterly'].map(tab => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            {tab}
                        </button>
                    ))}
